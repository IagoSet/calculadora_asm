...
div_op:
    ...
    ; Imprimir os números antes da divisão
    mov rax, rbx        ; Primeiro número (num1) em rax
    call print_int      ; Imprime o primeiro número
    mov rax, rsi        ; Segundo número (num2) em rax
    call print_int      ; Imprime o segundo número

    ; O dividendo deve estar em rax e o divisor em rbx
    mov rax, rbx        ; Coloca o primeiro número (num1) em rax
    mov rbx, rsi        ; Coloca o segundo número (num2) em rbx
    xor rdx, rdx        ; Limpa rdx antes da divisão
    div rbx             ; Divide rax pelo segundo número
    jmp print_result
