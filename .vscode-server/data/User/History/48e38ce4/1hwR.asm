...
_start:
    ...
    mov rsi, num1
    call str_to_int
    mov rax, rax  ; Armazena o primeiro número (dividendo) em rax

    mov rsi, num2
    call str_to_int  ; Converte o segundo número (divisor)
    mov rbx, rax  ; Agora o segundo número é armazenado em rbx
