section .data
    ...
    debug_msg db 'Debug: Valor do dividendo = ', 0
    debug_msg2 db 'Debug: Valor do divisor = ', 0
...
section .bss
    ...
    debug_res resb 15; buffer para os resultados de debug
...
_start:
    ...
    ; Debug: mostra o dividendo
    lea rsi, [debug_msg]
    call print_string
    call int_to_str
    mov rsi, debug_res
    call print_string  ; Printando valor do dividendo

    mov rsi, num2
    call str_to_int    ; converte o segundo número (divisor) para inteiro
    mov rbx, rax       ; armazenamos divisor em rbx

    ; Debug: mostra o divisor
    lea rsi, [debug_msg2]
    call print_string
    call int_to_str
    mov rsi, debug_res
    call print_string  ; Printando valor do divisor
...
div_op:
    ...
    je div_error        ; se for zero, entra em div_error
...
int_to_str:
    ...
    mov rsi, debug_res + 10  ; começa do final do buffer de debug
...
.write_zero:
    ...
    mov rdi, debug_res
    mov rdx, 11          ; tamanho máximo do buffer de debug
...
print_string:
    mov rax, 1
    mov rdi, 1          ; stdout
    mov rdx, 15         ; tamanho fixado para debug (ajuste conforme o tamanho)
    syscall
    ret