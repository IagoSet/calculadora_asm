...
_start:
    ...
    ; para debug, remova após verificar
    mov rdi, rax
    call print_value
    mov rdi, rbx
    call print_value
...
div_op:
    ...
    mov rbx, rsi        ; Move o segundo número (num2, já em rsi) para rbx
...
; ADICIONADO PARA IMPRESSÃO DO NÚMERO
print_value:
    ...
    mov rax, 1           ; Chama sistema para imprimir
    mov rdi, 1           ; Saída padrão
    mov rsi, result      ; A string do número
    mov rdx, 11          ; Tamanho máximo do buffer
    syscall
    ret
