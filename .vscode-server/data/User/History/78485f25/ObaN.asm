...
_start:
    ...
    call print_value ; Aqui você imprime num1

    mov rsi, num2
    call str_to_int  ; Converte o segundo número
    call print_value ; Aqui você imprime num2
...
div_op:
    ...
    je div_error        ; Se for zero, vai para div_error
    xor rdx, rdx        ; Limpa rdx antes da divisão
    ; O dividendo deve estar em rax e o divisor em rbx
    mov rax, rbx        ; Move o primeiro número (num1) para rax
    mov rbx, rsi        ; Move o segundo número (num2) para rbx
    div rbx             ; Divide rax pelo divisor em rbx
    jmp print_result     ; Continua para imprimir resultado
...
; Adicione esta função para imprimir o número armazenado em rax após a conversão
print_value:
    ; Imprime o número que está em rax
    mov rdi, rax         ; Move o valor para rdi para impressão
    call int_to_str      ; Converte o número para string
...
.loop:
    movzx rdx, byte [rsi]  ; Carrega o próximo caractere
